...
# inp=( 2 18 34 50 66 82 98 114 130 146 162 )
# out=( 2 18 34 50 66 82 98 114 130 146 162 )
inp=( 128 )
out=( 128 )
...
logfile="measurements/measurements_${name}_V"
    ...
    do
       for o in "${out[@]}"
        do
            ...
            echo "###" $i $o $c
            echo "####################################################"
            python scripts/generate_sweep_model.py $i $o $c lstm
